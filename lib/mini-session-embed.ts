...
export function miniSessionEmbedCode(slug: string, title: string, publicSubdomain?: string | null) {
  ...
  return `<iframe src="${embedUrl}" title="${safeTitle}" style="width:100%;max-width:720px;height:860px;border:0;border-radius:12px;overflow:hidden;background:transparent;" loading="lazy"></iframe>`;
}
