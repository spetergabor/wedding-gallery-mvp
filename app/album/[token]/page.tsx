  ...
  const copy =
    language === "hu"
      ? {
          ...
          submittedIntro: "Az albumellenőrzést elküldtétek. A jóváhagyások és a módosítási kérések már nem változtathatók.",
      ...
      : {
          ...
          submittedIntro: "Die Albumprüfung wurde übermittelt. Freigaben und Änderungswünsche können jetzt nicht mehr bearbeitet werden.",
      ...
      <header className="border-b border-ink/10 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-10">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-graphite/70">
            {review.submittedAt ? copy.submittedIntro : copy.intro}
          </p>
